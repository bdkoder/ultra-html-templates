...
//        return '<div class="gg-close gg-bt">&times</div><div class="gg-nxt gg-bt">&rarr;</div>';
        return '<div class="gg-close gg-bt"><i class="  fa fa-times fa-2x text-white"></i></div><div class="gg-nxt gg-bt"><i class="  fa fa-chevron-circle-right fa-2x text-white"></i></div>';
      }
      else if (p == l) {
        return '<div class="gg-close gg-bt"><i class="  fa fa-times fa-2x text-white"></i></div><div class="gg-prev gg-bt"><i class="  fa fa-chevron-circle-left fa-2x text-white"></i></div>';
      }
      else{
        return '<div class="gg-close gg-bt"><i class="  fa fa-times fa-2x text-white"></i></div><div class="gg-nxt gg-bt"><i class="next_img fa fa-chevron-circle-right fa-2x text-white"></i></div><div class="gg-prev gg-bt"><i class="  fa fa-chevron-circle-left fa-2x text-white"></i></div>';
      }
    }
    else{
